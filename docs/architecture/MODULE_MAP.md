...
| Model Gateway | `server/src/main/java/com/dailylanguage/modelgateway` | `TextGenerationPort`, `RoutedTextGenerationPort` | `ModelPurpose`, `ModelOperation`, `ModelRouteKey`, `ProviderId`, `ModelId`, `TransientProviderCredential`, `ModelResult`, `ModelFailure`, `ModelFailureKind`, `ModelUsage`, `ModelProviderCallException`, `TextGenerationRequest`, `TextMessage`, `TextOutputSpecification`, `TextGenerationResponse`, `TextGenerationRoute`, `FixedTextGenerationRoutes`, `TextGenerationProviderAdapter` | `ModelRouteKeyTests`, `ProviderModelIdentityTests`, `TransientProviderCredentialTests`, `ModelResultTests`, `ModelFailureTests`, `ModelProviderCallExceptionTests`, `TextGenerationRequestTests`, `TextGenerationResponseTests`, `TextGenerationPortTests`, `TextGenerationRouteTests`, `FixedTextGenerationRoutesTests`, `RoutedTextGenerationPortTests` | PARTIAL — M0-S7A IMPLEMENTED / REVIEW_PENDING；fixed route、explicit Port → Executor → Adapter Credential propagation、route-aware CREDENTIAL_UNAVAILABLE、final timeout 与 safe failure translation 可追踪；无 Browser / HTTPS ingress、concrete Provider、Structured Output validation 或 Trace persistence |
