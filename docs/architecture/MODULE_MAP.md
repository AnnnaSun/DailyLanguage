...
| Model Gateway | `server/src/main/java/com/dailylanguage/modelgateway` | `TextGenerationPort`, `RoutedTextGenerationPort` | `ModelPurpose`, `ModelOperation`, `ModelRouteKey`, `ProviderId`, `ModelId`, `ModelResult`, `ModelFailure`, `ModelFailureKind`, `ModelUsage`, `ModelProviderCallException`, `TextGenerationRequest`, `TextMessage`, `TextOutputSpecification`, `TextGenerationResponse`, `TextGenerationRoute`, `FixedTextGenerationRoutes`, `TextGenerationProviderAdapter` | `ModelRouteKeyTests`, `ProviderModelIdentityTests`, `ModelResultTests`, `ModelFailureTests`, `ModelProviderCallExceptionTests`, `TextGenerationRequestTests`, `TextGenerationResponseTests`, `TextGenerationPortTests`, `TextGenerationRouteTests`, `FixedTextGenerationRoutesTests`, `RoutedTextGenerationPortTests` | PARTIAL — M0-S6E COMPLETE (`c374449`)；fixed Text Generation route、dedicated Executor deadline、route-aware TIMEOUT 与 safe typed exception translation 可追踪；无 concrete Provider、Credential execution、Structured Output validation 或 Trace persistence |
